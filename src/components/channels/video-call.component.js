    ...
    <WoneInnerMain>
        <article>
            <div className="col-sm-12 col-md-12 col-lg-12 p-0">
                <h5 className="sx-page-title">VIDEO CALL</h5>
        ...
        <article>
            <div className="col-sm-12 col-md-12 col-lg-12 p-0 mb-3">
                <p>Wonesupport Video Call lets you talk to your customers when you’re being searched for, You can post ad that only will be shown to your customer.</p>
            </div>
            <div className="col-sm-12 col-md-12 col-lg-12 p-0">
                <div className="wone__caption-content">
                    <div className="wone__bb-style">
                        <h6>WoneSupport Video Call</h6>
                    </div>
                    <table>
                        <tbody>
                            <tr>
