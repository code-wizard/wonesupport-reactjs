            ...
            <WoneSidePanel>
                ...
                <div className="wone-links">
                    <ul>
                        ...
                        <li><Link className={this.isPathActive('/settings/account') ? 'active': ''} to="/settings/account">Account</Link></li>
                        <li><Link className={this.isPathActive('/settings/agents') ? 'active': ''} to="/settings/agents">Agents</Link></li>
                        <li><Link className={this.isPathActive('/settings/department') ? 'active': ''} to="/settings/department">Departments</Link></li>
                        <li><Link className={this.isPathActive('/settings/subscriptions') ? 'active': ''} to="/settings/subscriptions">Subscriptions</Link></li>
                        ...
                        <li><Link className={this.isPathActive('/settings/live-chart') ? 'active': ''} to="/settings/live-chart">Live Chat</Link></li>
                        <li><Link className={this.isPathActive('/settings/voice-call') ? 'active': ''} to="/settings/voice-call">Voice Calls</Link></li>
                        {/* <li><Link className={this.isPathActive('/dashboard/video-call') ? 'active': ''} to="/dashboard/video-call">Video Calls</Link></li> */}
                        <li><Link className={this.isPathActive('/settings/faqs') ? 'active': ''} to="/settings/faqs">FAQs</Link></li>
